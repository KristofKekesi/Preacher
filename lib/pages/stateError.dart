    ...
    return Scaffold(
      body: Builder(builder: (context) {
        ...
        Stack(
          ...
          children: <Widget>[
            Icon(Icons.bug_report_sharp, color: Colors.black, size: MediaQuery.of(context).size.width * .27,), // access_time
        BackdropFilter(
        ...
        2 *
        .02),
        child: Icon(Icons.bug_report_sharp, color: Colors.white, size: MediaQuery.of(context).size.width * .27,),), // access_time
          ],
        ),),
        ),),
        Padding(padding: EdgeInsets.only(bottom: MediaQuery.of(context).size.width * .03,),child: AutoSizeText(AppLocalizations.of(context).translate("errorStateTitle"), style: TextStyle(
        color: Colors.black,
        fontSize: MediaQuery.of(context).size.width * .08,
        fontWeight: FontWeight.bold,
        ),),),
                AutoSizeText(AppLocalizations.of(context).translate("errorStateSubTitle"),  style: TextStyle(
                  color: Colors.black,
